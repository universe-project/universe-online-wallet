...
{
	console.error('Iridium Framework Core must be included to be able to use Iridium Breakpoints.');
}
/**
 * Iridium URL Data.
 * This file is part of Iridium Framework project.
...
{
	console.error('Iridium Framework Core must be included to be able to use Iridium URL Data.');
}
/**
 * Iridium Animation.
 * This file is part of Iridium Framework project.
